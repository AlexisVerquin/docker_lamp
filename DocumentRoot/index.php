...
<head>
    ...
    <title>Bienvenue sur Docker LAMP by Veranet</title>
...
<div class="plane-loader">
    ...
    <div class="present">
        <h1 class="interest">Bienvenue sur Docker lamp by Veranet</h1>
        <p>
            Félicitations, vous avez réussi à installer correctement l'environnement, facile non ?
            Maintenant tout va se passer dans le répertoire <span class="interest">DocumentRoot</span>
        </p>
        <p>
            Une fois que vous auriez pris connaissance des informations ci-dessous vous pouvez supprimer
            ce fichier ou le renommer pour le garder en pense-bête
        </p>

        <p>
            Vous trouverez dans le dossier <span class="interest">errors</span> les pages d'erreur par défaut
        </p>
        <p>
            Vous pouvez les surcharger via un .htaccess dans votre/vos projets
        </p>
        <p class="end">
            Y'a plus qu'à
        </p>
